...
const JobCard = () => {
  ...
  const submitDisabled = () => {
    return Object.values(jobDescription).some(
  ...
  const inputs = [
    {
      inputName: "position",
      label: "Position",
      tooltip: "The title of the job you're hiring for.",
    },
    {
      inputName: "responsibilities",
      label: "Responsibilities",
      tooltip: "The responsibilities of the job, be descriptive.",
    },
    {
      inputName: "skills",
      label: "Skills",
      tooltip: "The skills a good candidate for this job should have.",
    },
    {
      inputName: "seniority",
      label: "Seniority",
      tooltip: "The seniority of the candidate you're looking for.",
    },
    {
      inputName: "location",
      label: "Location",
      tooltip: "The location of the job you're hiring for, remote, hybrid",
    },
  ];
