...
export const MessageParamsCard = ({
  genParams,
  handleChange,
  setGenParams,
}) => {
  return (
    <Card variant="outlined" sx={{ backgroundColor: "#4d4d4d", boxShadow: 3 }}>
      <CardContent style={{ paddingBottom: "15px" }}>
        <Typography variant="h5">Message Style</Typography>
        ...
        <FormControl fullWidth margin="normal">
          <InputLabel id="num-generations-label">
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Tooltip
            title={
              <h3 style={{ maxWidth: "120px", wordBreak: "break-word" }}>
                Length and verbosity of the message
              </h3>
            }
            placement="right"
            arrow
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Tooltip
            title={
              <h3 style={{ maxWidth: "120px", wordBreak: "break-word" }}>
                Ease of reading and language used
              </h3>
            }
            placement="right"
            arrow
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Tooltip
            title={
              <h3 style={{ maxWidth: "120px", wordBreak: "break-word" }}>
                Medium this message will be sent on
              </h3>
            }
            placement="right"
            arrow
        ...
        >
          <Slider
            ...
            onChange={(event, newValue) =>
              setGenParams({ ...genParams, creativity: newValue })
            }
            step={0.1}
            marks
            min={0}
